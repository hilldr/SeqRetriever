...
[[file:boxplots.png]]
** Print Heatmap
#+begin_src R :session *R* :exports both :results graphics :file heatmap.png :width 800 :height 400 :eval yes
SeqHeatmap(genes)
#+end_src
...
#+begin_src R :session *R* :exports both :results graphics :file pheatmap.png :eval yes

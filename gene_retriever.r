...
#
gene_retriever_pdf <- function(gene_names,nrow=3, dir= "./",csv.out="output.csv",pdf= "gr_output.pdf", w=8, h=11) {
...
gene_retriever_png <- function(gene_names,nrow=3, dir= "./",csv.out="output.csv",png= "gr_output.png") {
